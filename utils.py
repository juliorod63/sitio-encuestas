...
def transformacion_df(df):
    ...
    df.loc[df["Cargo"].str.contains("jefe", case=False), "Cargo"] = "Jefe/a"
    df.loc[df["Cargo"].str.contains("jefa", case=False), "Cargo"] = "Jefe/a"
    df.loc[df["Cargo"].str.contains("coordinador", case=False), "Cargo"] = "Coordinador/a"
    df.loc[df["Cargo"].str.contains("coordinación", case=False), "Cargo"] = "Coordinador/a"
    df.loc[df["Cargo"].str.contains("asistente", case=False), "Cargo"] = "Asistente"
    df.loc[df["Cargo"].str.contains("secretaría", case=False), "Cargo"] = "Secretaria"
    df.loc[df["Cargo"].str.contains("secretaria", case=False), "Cargo"] = "Secretaria"
    df.loc[df["Cargo"].str.contains("encargado", case=False), "Cargo"] = "Encargado"
    df.loc[df["Cargo"].str.contains("encargada", case=False), "Cargo"] = "Encargado"
    df.loc[df["Cargo"].str.contains("administrativo", case=False), "Cargo"] = "Administrativo"
    df.loc[df["Cargo"].str.contains("administrativa", case=False), "Cargo"] = "Administrativo"
    df.loc[df["Cargo"].str.contains("psicologo", case=False), "Cargo"] = "Psicologo/a"
    df.loc[df["Cargo"].str.contains("psicólogo", case=False), "Cargo"] = "Psicologo/a"
    df.loc[df["Cargo"].str.contains("psicologa", case=False), "Cargo"] = "Psicologo/a"
    df.loc[df["Cargo"].str.contains("psicóloga", case=False), "Cargo"] = "Psicologo/a"
    df.loc[df["Cargo"].str.contains("psicopedagoga", case=False), "Cargo"] = "Psicopedagogo/a"
    df.loc[df["Cargo"].str.contains("psicopedagogo", case=False), "Cargo"] = "Psicopedagogo/a"
    df.loc[df["Cargo"].str.contains("orientador", case=False), "Cargo"] = "Orientador/a"
    df.loc[df["Cargo"].str.contains("orientadora", case=False), "Cargo"] = "Orientador/a"
    df.loc[df["Cargo"].str.contains("profesor jefe", case=False), "Cargo"] = "Jefe/a"
    df.loc[df["Cargo"].str.contains("inspector", case=False), "Cargo"] = "Inspector/a"
    df.loc[df["Cargo"].str.contains("inspectora", case=False), "Cargo"] = "Inspector/a"
    df.loc[df["Cargo"].str.contains("profesional de apoyo", case=False), "Cargo"] = "Profesional de Apoyo"
    df.loc[df["Cargo"].str.contains("docente", case=False), "Cargo"] = "Docente"
    df.loc[df["Cargo"].str.contains("profesor de", case=False), "Cargo"] = "Docente"
    df.loc[df["Cargo"].str.contains("profesora de", case=False), "Cargo"] = "Docente"
    df.loc[df["Cargo"].str.contains("profesor", case=False), "Cargo"] = "Docente"
    df.loc[df["Cargo"].str.contains("monitor", case=False), "Cargo"] = "Inspector"
    df.loc[df["Cargo"].str.contains("monitora", case=False), "Cargo"] = "Inspector"
    df.loc[df["Cargo"].str.contains("gerente", case=False), "Cargo"] = "Gerente"
    ...
    df.loc[df["Cargo"].str.contains("dirección", case=False), "Cargo"] = "Director/a"
    df.loc[df["Cargo"].str.contains("encargada de convivencia escolar", case=False), "Cargo"] = "Encargado"
    df.loc[df["Cargo"].str.contains("encargada de convivencia escolar", case=False), "Cargo"] = "Encargado"
    df.loc[df["Cargo"].str.contains("encargado de convivencia escolar", case=False), "Cargo"] = "Encargado"
    df.loc[df["Cargo"].str.contains("subdirector", case=False), "Cargo"] = "Director/a"
    df.loc[df["Cargo"].str.contains("subdirectora", case=False), "Cargo"] = "Director/a"
    df.loc[df["Cargo"].str.contains("encargada de biblioteca", case=False), "Cargo"] = "Bibliotecario/a"
    df.loc[df["Cargo"].str.contains("encargado de biblioteca", case=False), "Cargo"] = "Bibliotecario/a"
    df.loc[df["Cargo"].str.contains("bibliotecaria", case=False), "Cargo"] = "Bibliotecario/a"
    df.loc[df["Cargo"].str.contains("bibliotecario", case=False), "Cargo"] = "Bibliotecario/a"
    df.loc[df["Cargo"].str.contains("técnico", case=False), "Cargo"] = "Técnico/a"
    df.loc[df["Cargo"].str.contains("técnica", case=False), "Cargo"] = "Técnico/a"
    df.loc[df["Cargo"].str.contains("convivencia", case=False), "Cargo"] = "Convivencia"
    df.loc[df["Cargo"].str.contains("consejero", case=False), "Cargo"] = "Consejero/a"
    df.loc[df["Cargo"].str.contains("consejera", case=False), "Cargo"] = "Consejero/a"
    df.loc[df["Cargo"].str.contains("encargado", case=False), "Cargo"] = "Encargado/a"
    df.loc[df["Cargo"].str.contains("encargada de recursos", case=False), "Cargo"] = "Encargado/a"
    df.loc[df["Cargo"].str.contains("educador", case=False), "Cargo"] = "Docente"
    df.loc[df["Cargo"].str.contains("enfermer", case=False), "Cargo"] = "Enfermero/a"
    df.loc[df["Cargo"].str.contains("apoderad", case=False), "Cargo"] = "Apoderado/a"
    df.loc[df["Cargo"].str.contains("teacher", case=False), "Cargo"] = "Docente"
    df.loc[df["Cargo"].str.contains("utp", case=False), "Cargo"] = "Coordinador/a"
    df.loc[df["Cargo"].str.contains("asesor", case=False), "Cargo"] = "Asesor/a"
    df.loc[df["Cargo"].str.contains("maestra", case=False), "Cargo"] = "Docente"
    df.loc[df["Cargo"].str.contains("subdirección", case=False), "Cargo"] = "Director/a"
    df.loc[df["Cargo"].str.contains("jede", case=False), "Cargo"] = "Jefe/a"
    df.loc[df["Cargo"].str.contains("jefe de", case=False), "Cargo"] = "Jefe/a"
    df.loc[df["Cargo"].str.contains("ed.", case=False), "Cargo"] = "Docente"
    df.loc[df["Cargo"].str.contains("recretaria", case=False), "Cargo"] = "Secretaria"
    df.loc[df["Cargo"].str.contains("soporte", case=False), "Cargo"] = "Soporte Sistemas"
    df.loc[df["Cargo"].str.contains("porter", case=False), "Cargo"] = "Mantenimiento"
    df.loc[df["Cargo"].str.contains("mantencion", case=False), "Cargo"] = "Mantenimiento"
